...
const SnackBar = ({snackMessage, isError, onClick}) => {
    return(
        <div className={`max-w-lg left-0 sticky  ${isError ? "bg-primary" : "bg-green"} right-0 rounded-lg bottom-16 h-12 flex shadow-lg`}> 
...
const Dialog = ({toggleDialog, item, onCancel, onDelete}) => {
    return (
        <div className={"bg-white w-3/4 md:w-1/4 rounded shadow-lg"}>
            {toggleDialog ? (
                <div className={"p-4"}>
                    <p className={"text-xs tracking-wider text-textGrey uppercase mb-1"}>{"Confirm Deletion"}</p>
                    <p className={"text-sm font-semibold tracking-wider"}>{item}</p>
...
const Page = ({query}) => {
    ...
    console.log("FROM DETAIL!!!", {application});
    ...
    return (
        <TabLayout>
            <div className={"flex flex-col max-w-lg mx-auto px-4"}>
                ...
                <div>
                    <p className={"text-primary uppercase text-xs mb-2"}>{'Application Details'}</p>
                    <p className={"text-2xl font-semibold"}>{name}</p>
                    {/* <Spacer className={"block h-2"} />
                    <p className={"text-sm text-textGrey"}>{description}</p> */}
                    <div className={"my-2 py-2 text-xs font-semibold px-2 gap-6 md:flex grid grid-cols-2 md:justify-start"}>
                        ...
                        <Button
                            ...
                            className={"rounded focus:outline-none py-2 md:w-40 appearance-none text-primary border border-primary uppercase px-2 outline-none bg-white"}
                        >
                            Delete
                        </Button>
                    </div>
                    ...
                    {description && (
                        <div className={"flex flex-col py-3 border-b border-textGrey border-opacity-10"}>
                            <p className={"text-textGrey text-xs uppercase tracking-wider mb-1"}>{"Description"}</p>
                    ...
                    {status && (
                        <div className={"flex justify-between py-4 border-b border-textGrey border-opacity-10"}>
                            <p className={"text-textGrey text-xs uppercase tracking-wider"}>{"Status"}</p>
                            <p className={"tracking-wider text-xs font-semibold uppercase"}>{status.name}</p>
                        </div>
                    )}
                    {pk && (
                        <div className={"flex justify-between py-4 border-b border-textGrey border-opacity-10"}>
                            <p className={"text-textGrey text-xs uppercase tracking-wider"}>{"App-ID"}</p>
                        ...
                        <div className={"flex flex-col py-4 border-b border-textGrey border-opacity-10"}>
                            <div className={"w-full flex justify-between"}>
                                <div className={"flex justify-start items-center"}>
                                    <p className={"text-textGrey text-xs uppercase tracking-wider"}>{"Client Secret"}</p>
                                </div>
                                <div>
                                    <Button 
                                        onClick={toggleSecret}
                                        className={"uppercase text-xs font-semibold text-primary tracking-wider outline-none focus:outline-none"}>
                    ...
                    <div className={"flex flex-col py-4 border-b border-textGrey border-opacity-10"}>
                        ...
                        <div className={"flex flex-col"}>
                            <p className={"text-textGrey text-xs uppercase tracking-wider"}>{"Access Token"}</p>
                            <Spacer className={"block h-2"} />
                            {application_token ? (
                                <Fragment>
                                    <div className={"flex flex-wrap bg-backgroundGrey py-4 px-2 rounded"}>
                        ...
                        <div className={"flex flex-col"}>
                            <p className={"text-textGrey text-xs uppercase tracking-wider"}>{"Refresh Token"}</p>
                            <Spacer className={"block h-2"} />
                            {application_token ? (
                                <Fragment>
                                    <div className={"flex flex-wrap bg-backgroundGrey py-4 px-2 rounded"}>
                    ...
                    {website_url && (
                        <div className={"flex flex-col py-4 border-b border-textGrey border-opacity-10"}>
                            <p className={"text-textGrey text-xs uppercase tracking-wider"}>{"website Url"}</p>
                            <Spacer className={"block h-2"} />
                            <div className={"flex flex-wrap bg-backgroundGrey py-4 px-2 rounded"}>
                    ...
                    {web_hooks && (
                        <div className={"flex flex-col py-4 border-b border-textGrey border-opacity-10"}>
                            <p className={"text-textGrey text-xs uppercase tracking-wider"}>{"Redirect Url"}</p>
                            <Spacer className={"block h-2"} />
                    ...
                    {logo_url && (
                        <div className={"flex flex-col py-4 border-b border-textGrey border-opacity-10"}>
                            <p className={"text-textGrey text-xs uppercase tracking-wider"}>{"Logo Url"}</p>
                            <Spacer className={"block h-2"} />
                            <div className={"flex flex-wrap bg-backgroundGrey py-4 px-2 rounded"}>
                                <p className={"text-left tracking-wider text-xs break-all"}>
                    ...
                    {privacy_url && (
                        <div className={"flex flex-col py-4 border-b border-textGrey border-opacity-10"}>
                            <p className={"text-textGrey text-xs uppercase tracking-wider"}>{"privacy Url"}</p>
                            <Spacer className={"block h-2"} />
                            <div className={"flex flex-wrap bg-backgroundGrey py-4 px-2 rounded"}>
                                <p className={"text-left tracking-wider text-xs break-all"}>
                    ...
                    {terms_and_conditions_url && (
                        <div className={"flex flex-col py-4 border-b border-textGrey border-opacity-10"}>
                            <p className={"text-textGrey text-xs uppercase tracking-wider"}>{"terms & conditions Url"}</p>
                            <Spacer className={"block h-2"} />
                            <div className={"flex flex-wrap bg-backgroundGrey py-4 px-2 rounded"}>
                                <p className={"text-left tracking-wider text-xs break-all"}>
