    ...
    return(
        <div className={"flex flex-col max-w-lg mx-auto px-4"}>
            ...
            <div className={"flex flex-col justify-center items-center"}>
                <p className={"text-xl font-semibold tracking-wider"}>{"Encountered an Error"}</p>
                <Spacer className={"block h-2"} />
                {/* <p className={"text-textGrey tracking-wide"}>{'We are not able to complete your request. Please try again, or contact support'}</p> */}
            </div>
