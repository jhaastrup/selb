...
import { TOPUP_DETAIL } from '../modules/queries';
...
const Page = ({query}) => {
    ...
    const { loading, data, error, refetch } = useQuery(TOPUP_DETAIL, {
    ...
    const { source, status, code, pk, comment, amount, date_created } = data.getTopUp

    return (
        <TabLayout pageTitle={"Topup Detail"}>
