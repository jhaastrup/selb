    ...
    return(
        <div className={"flex flex-col max-w-lg mx-auto px-4"}>
            ...
            <div className={"flex flex-col justify-center items-center"}>
                <p className={"text-lg text-center font-semibold tracking-wider"}>{'Oops!'}</p>
                <Spacer className={"block h-2"} />
                <p className={"text-textGrey text-center tracking-wide"}>{'Your transaction was not successful. If this continues, please check with your bank or contact support.'}</p>
            </div>
